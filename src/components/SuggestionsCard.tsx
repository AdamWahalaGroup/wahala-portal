 ...
 * next actions. Humans ✓ do or ✕ dismiss; agents never act outward themselves.
...
export type SuggestionItem = { id: string; title: string; bodyMd: string | null; createdAt: string };
